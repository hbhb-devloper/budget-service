...
@NoArgsConstructor
@AllArgsConstructor
public class BudgetProjectDetailExportVO {
     ...
     * 二维集合（两条节点为一组，纵向排列）
     */
    private List<List<BudgetProjectFlowExportVO>> flows;
    ...
    @Schema(description = "已审批的百分比")
    private String declaredPer;

    @Schema(description = "申报中（万元）")
    private String declaring;

    @Schema(description = "申报中的百分比")
    private String declaringPer;

    @Schema(description = "未申报（万元）")
    private String declaration;

    @Schema(description = "未审批的百分比")
    private String declarationPer;
    ...
    private List<BudgetProjectFileExportVO> files;

    /**
     * ===================分类预算===================
     */
    private List<BudgetProjectSplitExportVO> splits;
}